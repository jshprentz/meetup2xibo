...
To install Meetup to Xibo, run this command in your terminal:

.. code-block:: console

    $ pip install meetup2xibo

This is the preferred method to install Meetup to Xibo, as it will always install the most recent stable release.
...
The sources for Meetup to Xibo can be downloaded from the `Github repo`_.
