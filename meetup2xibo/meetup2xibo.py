...
from config import MEETUP_API_CONFIG, LOCATION_CONFIG, XIBO_DB_CONNECTION, XIBO_DB_COLUMN_NAMES, XIBO_DATASET_CODE
...
class Meetup2Xibo:
    ...
    def update_xibo_events(self, meetup_events):
        ...
        db_connection = connect_to_xibo_db(XIBO_DB_CONNECTION, XIBO_DB_COLUMN_NAMES, XIBO_DATASET_CODE)
