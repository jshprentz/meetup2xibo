...
""".format(self.site_url, self.site_ca_path)
    ...
    def append_site_cert(self):
        """Append the site-specific certificate authority file
        to the Python Requests certificate authority file."""
        self.logger.info("Appending site CA %s to system CA list %s", self.site_ca_path, self.sys_ca_path)
